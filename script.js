const dadosTreinos = {
  "treino_a": {
    ...
    "subtitulo": "Conjugado",
    "exercicios": [
      {"nome": "Supino Reto com barrra", "execucao": "4 séries • 8/12 reps", "peso": "12.5/20", "tec": "PC/CC", "obs": "Pirâmide Crescente (aumente o peso a cada série). | Cadência controlada (3 seg. na descida)." },
      {"nome": "Remada Baixa", "execucao": "4 séries • 8/12 reps", "peso": "15/20", "tec": "RP", "obs": "Rest-Pause na última série (faça 6 reps, descanse 15s, faça o máximo que aguentar) | __" },
      {"nome": "Desenvolvimento (Ombros)", "execucao": "3 séries • 10/12 reps", "peso": "5/7", "tec": "Bi-set", "obs": "Fazer 30s de polichinelos" },
      {"nome": "Puxada Alta Unilateral", "execucao": "3 séries • 10/12 reps", "peso": "19/33", "tec": "CM/DS", "obs": "Foco na contração máxima das costas. | Drop-set na última série (reduz o peso em 30% e faz até a falha)" },
      {"nome": "Rosca Cabo + Tríceps Unilateral", "execucao": "3 séries • 12 reps", "peso": "5/5", "tec": "Super-Série", "obs": "Um exercício seguido do outro sem descanso." },
  ...
  "treino_c": {
    ...
    "subtitulo": "Conjugado",
    "exercicios": [
      {"nome": "Agachamento Sumô (pit shark)", "execucao": "4 séries • 10/15 reps", "peso": "-", "tec": "PC", "obs": "Carga pesada, foco em explosão na subida. | Pico de contração de 2s no topo (espremendo o glúteo)." },
      ...
      {"nome": "Remada com Barra", "execucao": "3 séries • 8/15 reps", "peso": "-", "tec": "DS", "obs": " __ | Drop-set na última série (reduz o peso e faz até falhar)." },
      {"nome": "Desenvolvimento Arnold", "execucao": "3 séries • 10/12 reps", "peso": "5/7", "tec": " ", "obs": " " },
      {"nome": "Levantamento Frontal (Anilha)", "execucao": "3 séries • 12 reps", "peso": " ", "tec": " ", "obs": " "},
  ...
  "treino_d": {
    ...
    "exercicios": [
      ...
      {"nome": "Supino Reto com halteres", "execucao": "3 séries • 12 reps", "peso": "6/6kg", "tec": " ", "obs": " ." },
